 ...
 */
public class ListAdapter_BLE_Services extends BaseExpandableListAdapter {
    ...
    public ListAdapter_BLE_Services(Activity activity, ArrayList<BluetoothGattService> listDataHeader,
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (BLEUtilities.hasReadProperty(properties) != 0) {
            sb.append("R");
        }
        ...
        if (data != null) {
            tv_value.setText("Value: " + BLEUtilities.hexToString(data));
        }
        else {
